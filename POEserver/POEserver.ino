        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("<html>");
            ...
            if (sensorReading > 1000){
              client.print("Patrick at Desk<br />"); 
            }else{
              client.print("Patrick away Desk<br />");
            }
          ...
          client.println("<br />");
          client.print("<small>Arduino POE Ethernet + Simplytronics Wide Angle PIR + Parallax 4x30 LCD</small>");
          client.println("</html>");
          break;
        }
        if (c == '\n') {
